...
int main(int argc, const char *argv[])
{
	...
	{	//为语音播报做准备
		...
		bzero(buf,sizeof(buf));
		ret = recv(cfd2,buf,sizeof(buf)-1,0);
		if(-1 == ret)
		{
			printf("recv");
			exit(EXIT_FAILURE);
